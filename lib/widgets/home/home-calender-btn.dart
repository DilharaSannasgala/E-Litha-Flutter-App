            ...
            child: Row(
              ...
              children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              textTitle,
                              style: TextStyle(
                                color: AppColor.isDark ? AppColor.btnTextColor.withOpacity(0.9) : Colors.white.withOpacity(0.9),
                                fontSize: 22,
                                height: 1.2,
                            ...
                            Text(
                              textYear,
                              style: TextStyle(
                                color: AppColor.isDark ? AppColor.btnTextColor : Colors.white,
                                fontSize: 44,
                                height: 1.0,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color: AppColor.isDark ? AppColor.accentColor.withOpacity(0.2) : Colors.white,
                  ),
                  child: Center(
                    child: Icon(
